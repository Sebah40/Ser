    ...
    <section class="about-section">
      ...
      <div class="content-container">
        ...
        <div class="energy-stats-title">
          ...
          <p class="energy-stats-subtitle">Impacto acumulado de todos nuestros sistemas instalados</p>
        </div>
...
.overlay{
    ...
    right:0;
    bottom:0;
    background:linear-gradient(135deg,rgba(255,255,255,0.28) 0%,rgba(0,0,0,0.6) 100%)
}
.content-container{
    position:relative;
    z-index:2;
